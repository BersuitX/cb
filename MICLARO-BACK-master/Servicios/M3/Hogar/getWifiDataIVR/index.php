...
$Vb1jhtbuqbys['urlServicio']="https://172.31.228.201/pollerWs_test/services/DiagResService?wsdl"; 
...
$V0ojkog2p2jp->map(['POST'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
    ...
    if($VqhzkfsafzrcRes["error"] == 0){
        ...
        $V4kfh5akqyzi = "getWifiDataIVRResponse";
        ...
        if(isset($VqhzkfsafzrcRes->getWifiDataIVRReturn->enableWireless)=="true"){
            $Vqhzkfsafzrc=$VqhzkfsafzrcRes->getWifiDataIVRReturn;
