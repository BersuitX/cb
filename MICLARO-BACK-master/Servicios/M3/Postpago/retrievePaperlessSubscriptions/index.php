...
$V0ojkog2p2jp->map(['POST'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
  ...
  $Vqhzkfsafzrc=validarSeguridad($Vyvmmv0t5uw2->getHeaders());
    ...
    if($VqhzkfsafzrcRes["error"] == 0){
        ...
        $V4kfh5akqyzi = "ns2retrievePaperlessSubscriptionsResponse";
        ...
        if(isset($VqhzkfsafzrcRes["response"],$VqhzkfsafzrcRes["response"]->$V4kfh5akqyzi)){
           ...
           $Vpsm42ro4mkq=(($VqhzkfsafzrcRes->AcknowledgementIndicator=="SUCCESS")?0:1);
			...
			if (($Vpsm42ro4mkq==1)){
			 ...
			 if(isset($VqhzkfsafzrcRes->SubscriptionList) && sizeof($VqhzkfsafzrcRes->SubscriptionList) > 0){

		            foreach ($VqhzkfsafzrcRes->SubscriptionList as $Virsew13xpli){

		                $Virsew13xpli = (array)$Virsew13xpli;
		                $Vuz2tqweebiu=array("EmailAddress"=>$Virsew13xpli["EmailAddress"]?$Virsew13xpli["EmailAddress"]:"",                 
		                "MobileNumber"=>$Virsew13xpli["MobileNumber"]?$Virsew13xpli["MobileNumber"]:0,
		                "NotificationId"=>$Virsew13xpli["NotificationId"]?$Virsew13xpli["NotificationId"]:0,
		                "NotificationType"=>$Virsew13xpli["NotificationType"]?$Virsew13xpli["NotificationType"]:0,
		                "SendingDate"=>$Virsew13xpli["SendingDate"]?$Virsew13xpli["SendingDate"]:"",
		                "UserProfileID"=>$Virsew13xpli["UserProfileID"]?$Virsew13xpli["SendingDate"]:"");
