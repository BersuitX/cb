...
$V0ojkog2p2jp->map(['POST','OPTIONS'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
    ...
    $Vy5yyyefdntg[]="SOAPAction: \"Claro.SelfCareManagement.Services.Entities.Contracts/SelfCareManagementService/validarCompraPaquetePartido\"";
    ...
    if($VqhzkfsafzrcRes["error"] == 0){
        ...
        $V4kfh5akqyzi = "ValidarCompraPaquetePartidoResponse";
        ...
        if(isset($VqhzkfsafzrcRes["response"],$VqhzkfsafzrcRes["response"]->$V4kfh5akqyzi)){
           ...
           $Vlfwkhon2bz0["error"]=0;
            if ($VqhzkfsafzrcRes->esCompraValida=="true") {
             $Vlfwkhon2bz0["response"]=array("valido"=>1);
            }else{
             $Vlfwkhon2bz0["response"]=array("valido"=>0);
            }
        }
    }
    else{
