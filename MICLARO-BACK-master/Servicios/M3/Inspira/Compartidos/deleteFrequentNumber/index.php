...
$Vb1jhtbuqbys['urlServicio']="http://172.24.42.39:8002/CustomerManagement/v1.0/?wsdl"; 
...
$V0ojkog2p2jp->map(['POST'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
    ...
    $VqhzkfsafzrcRes=$this->curlWigi->soap($Vy5yyyefdntg,true);
     ...
     if($VqhzkfsafzrcRes["error"] == 0){
      $V4kfh5akqyzi = "ns0deleteFrequentNumberResponse";
        $Vlfwkhon2bz0 = array();
  ...
  if($VqhzkfsafzrcRes->_responseStatus->code=="FS_ESB_0"){
        if($VqhzkfsafzrcRes->_responseStatus->message=="Transaction completed"){
            $Vlfwkhon2bz0["error"]=0; 
            $Vlfwkhon2bz0["response"] = "Registro eliminado exitosamente.";
         ...
         if($VqhzkfsafzrcRes->_responseStatus->message=="Transaction Failed"){
            $Vlfwkhon2bz0["error"]=1; 
            $Vlfwkhon2bz0["response"] = "No fue posible realizar la operación en este momento. Inténtalo de nuevo";
