...
$V0ojkog2p2jp->map(['POST'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
    ...
    $Vy5yyyefdntg[]="SOAPAction: \"Claro.SelfCareManagement.Services.Entities.Contracts/SelfCareManagementService/registrarAliasCuenta\"";
    ...
    $VqhzkfsafzrcRes=$this->curlWigi->soap($Vy5yyyefdntg,true);
        ...
        $V4kfh5akqyzi = "RegistroAliasCuentaResponse";
        ...
        $Vlfwkhon2bz0["error"]=0;
        $Vlfwkhon2bz0["response"]="¡Nombre actualizado correctamente!";
              }else{
