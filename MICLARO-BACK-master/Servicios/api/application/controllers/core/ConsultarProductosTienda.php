...
class ConsultarProductosTienda extends REST_Controller {
    ...
    function index_post()
    {
        ...
        $Vfcughmysbun = (isset($Vfeinw1hsfej) && $Vfeinw1hsfej != NULL && isset($Vfeinw1hsfej["AccountId"]));
            ...
            $Vfvggg0pmnws = $this->db->query("select * from vw_repos_listaProductos where idCategoria <> ".$Vblkx0hyj0dw);
            $Ve2pnzw21kc1 = $Vfvggg0pmnws->result();
            
            $Vfvggg0pmnwsCat = $this->db->query("select productoCategoriaID as idCategoria,nombre as categoria from repos_ProductoCategorias where productoCategoriaID <> ".$Vblkx0hyj0dw);
            $V3h5pamseawo = $Vfvggg0pmnwsCat->result();
            ...
            if(count($Ve2pnzw21kc1) > 0) {
                ...
                $Vcmaitbcbmmk = '/var/www/miclaroapp.com.co/public_html/archivos/fotosTienda/';
                $Vt4hipms1i3k = "https://www.miclaroapp.com.co/archivos/fotosTienda";
                ...
                if($Vfcughmysbun){
                    ...
                    $V1urt3egvgve = json_decode(((isset($V1urt3egvgve))?$V1urt3egvgve:1));
                ...
                $Vfeinw1hsfejRes = array("aplicaPagoFactura"=>$Vrdos1yq12ia,"aplicaPagoFinanciado"=>$Vf5ummwstfub,"productos"=>$V5bl3u22kt0w,"costoMinimo"=>30000,"categorias"=>$V3h5pamseawo);
