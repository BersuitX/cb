...
var INB_app = {
  ...
  sdkConfig: {
    chatbotId: "claro_co_chatbot_miclaro_es",           // UI identifier
    environment: "development",                         // Environments => development / preproduction / production
    lang: "es",
    userType: 1,                                        // Profile "MiClaro" in instance claro_co_chatbot_es
    closeButton: {
      visible: true
    },
    labels: {
  ...
  appConfig: {
    ...
    federatedBotProfile: "3" // Profile "MiClaro" in instance claro_co_faq_es
  }
}
