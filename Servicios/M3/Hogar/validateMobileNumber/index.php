...
$V0ojkog2p2jp->map(['POST'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
    ...
    if($VqhzkfsafzrcRes["error"] == 0){
        ...
        $V4kfh5akqyzi = "ns2validateMobileNumberResponse";
        ...
        if(isset($VqhzkfsafzrcRes["response"],$VqhzkfsafzrcRes["response"]->$V4kfh5akqyzi)){
            ...
            if (intval($VqhzkfsafzrcRes->AcknowledgementIndicator->error)=="SUCCESS") {
                $VqhzkfsafzrcRes = (array)$VqhzkfsafzrcRes;
                if(isset($VqhzkfsafzrcRes["IsValidFlag"])){
                     $V23hrse2zwva = $VqhzkfsafzrcRes["IsValidFlag"];
                }
                
                $Vlfwkhon2bz0["error"]=0;
                $Vlfwkhon2bz0["response"]=array("IsValidFlag"=>$V23hrse2zwva);
            }
            else{
