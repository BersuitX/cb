...
$Vb1jhtbuqbys['urlServicio']="http://172.24.42.39:8002/CustomerProductMgmt/v1.0/?wsdl"; 
...
$V0ojkog2p2jp->map(['POST'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
    ...
    $VqhzkfsafzrcRes=$this->curlWigi->soap($Vy5yyyefdntg,true);
     ...
     if($VqhzkfsafzrcRes["error"] == 0){
      $V4kfh5akqyzi = "tnsactivePackagesResponse";
        $Vlfwkhon2bz0 = array();
    ...
    if($VqhzkfsafzrcRes->_responseStatus->status=="OK"){
        $Vlfwkhon2bz0["error"]=0; 
        $Vpsm42ro4mkq = strtolower($VqhzkfsafzrcRes->_responseStatus->message);
     
        if($Vpsm42ro4mkq == "transaction completed"){
            $Vpsm42ro4mkq = "Operación Completa.";
        }
