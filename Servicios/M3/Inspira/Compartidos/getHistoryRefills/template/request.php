...
xmlns:v1="http://www.ericsson.com/esb/message/customer/getHistoryRefillsRequest/v1.0/">
   <soapenv:Header>
      <v2:headerRequest>
   ...
   <soapenv:Body>
      <v1:getHistoryRefillsRequest>
         <subscriberNumber>57<?=$Vqhzkfsafzrc->AccountId?></subscriberNumber>
         <searchLimit>10</searchLimit>
         <!--Optional:-->
         <snapEndDate><?=$Vqhzkfsafzrc->FechaFinal?></snapEndDate>
         <!--Optional:-->
         <snapStartDate><?=$Vqhzkfsafzrc->FechaInicial?></snapStartDate>
         <!--Optional:-->
