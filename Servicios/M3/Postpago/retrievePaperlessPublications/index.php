...
$V0ojkog2p2jp->map(['POST'], '/', function (Request $Vyvmmv0t5uw2, Response $Vvcjkdrakwx3, array $Veox3iprl5oz) {
    ...
    if($VqhzkfsafzrcRes["error"] == 0){
        ...
        $V4kfh5akqyzi = "ns2retrievePaperlessPublicationsResponse";
        ...
        if(isset($VqhzkfsafzrcRes["response"],$VqhzkfsafzrcRes["response"]->$V4kfh5akqyzi)){
            ...
            if (($Vpsm42ro4mkq==1)){
                ...
                $Vw10cior02ni = array();
                if(isset($VqhzkfsafzrcRes->PublicationList) && sizeof($VqhzkfsafzrcRes->PublicationList) > 0){

                	foreach ($VqhzkfsafzrcRes->PublicationList as $Virsew13xpli) {
                		...
                		$Vuz2tqweebiu = array("SendingDate"=>$Virsew13xpli["SendingDate"]?$Virsew13xpli["SendingDate"]:"",
                			...
                			"Invoice"=>$Virsew13xpli["Invoice"]?$Virsew13xpli["Invoice"]:0,
                			"InvoiceDate"=>$Virsew13xpli["InvoiceDate"]?$Virsew13xpli["InvoiceDate"]:"",
                			"InvoiceValue"=>$Virsew13xpli["InvoiceValue"]?$Virsew13xpli["InvoiceValue"]:0,
